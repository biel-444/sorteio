...
function cliqueDeSorteio(){
    ...
    var times = ['Manchester City', 'Real Madrid', 'Atalanta', 'Borussia Dortmund','Paris Saint-Germain','Liverpool','Bayer Münich','Arsenal','Atlético De Madrid','Internazionale','Porto','Bayer Leverkusen','Chelsea','Sporting',
    'Milan','RB Leipzig','Barcelona','Napoli','Real Sociedad','West Ham','Club Brugge','PSV ','Benfica','Juventus','Lille','Aston Villa','Sevilla','Olympique Marseille','Freiburg','Manchester United','Internacional','Grêmio']
